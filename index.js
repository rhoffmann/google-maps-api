 ...
 * ```
 */
module.exports = function( options, libraries, onComplete ) {

  var apiVersion;

  // old API fallback when options is the API key.
      ...
      if( !key ) {
        ...
        if( maps ) {
          ...
          if (callBacks.length == 1) {
            ...
            var url = 'https://maps.googleapis.com/maps/api/js?v='+ apiVersion +'&callback=$$mapsCB' + auth;
